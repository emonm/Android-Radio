...
package org.oucho.radio.utils.color;
...
public class ColorPickerView extends View {
    ...
    private void drawAlphaPanel(Canvas canvas) {
        ...
        if (mAlphaSliderText != null && !"".equals(mAlphaSliderText)) {
    ...
    private float[] pointToSatVal(float x, float y) {
        ...
        result[0] = 1.f / width * xx;
        result[1] = 1.f - (1.f / height * yy);
